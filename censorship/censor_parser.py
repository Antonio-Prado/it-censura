...
in_format_list = ['cncpo', 'aams', 'admt', 'agcom', 'consob', 'ivass', 'manuale']
...
def main():
    ...
    elif options.in_format == 'ivass':
        dns_bl = parse_ivass_list(options.in_file)
